...
//!    - Currently supports: `StakingOperatorsErrors`, we need to add more for the custom contracts such as blacklightRouterErrors
...
// Note: blacklightRouter currently uses require() with string messages, not custom errors.
// When custom errors are added to the contract, they will be automatically available
// via blacklightRouter::blacklightRouterErrors and should be added here.
