...
//!    - Currently supports: `StakingOperatorsErrors`, we need to add more for the custom contracts such as NilAVRouterErrors
...
//!         → "NilAV: HTX already exists" (human-readable!)
//! ```
//!
//! ## Example
//!
...
//! You now see:
//! ```text
//! error: NilAV: HTX already exists
//! ```
//!
//! ## Main Entry Points
//!
...
pub use super::staking_operators::StakingOperators::StakingOperatorsErrors;

// Note: NilAVRouter currently uses require() with string messages, not custom errors.
// When custom errors are added to the contract, they will be automatically available
// via NilAVRouter::NilAVRouterErrors and should be added here.
...
/// println!("Error: {}", decoded); // "NilAV: HTX already exists"
/// ```
...
fn try_extract_from_string(error_str: &str) -> Option<DecodedRevert> {
    ...
    // Some RPC providers return: `execution reverted: NilAV: HTX already exists`
